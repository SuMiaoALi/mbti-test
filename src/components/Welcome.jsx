    ...
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="card max-w-md w-full text-center animate-fade-in relative z-10 hover:shadow-xl">
        <div className="mb-6">
          ...
          <h1 className="text-4xl font-bold mb-3 animate-bounce-in">
            <span className="gradient-text">MBTI</span>
            <span className="text-slate-800 ml-2">人格测试</span>
          </h1>
          
          <p className="text-slate-600 text-lg font-medium animate-slide-up" style={{animationDelay: '0.2s'}}>
        ...
        <div className="space-y-4 mb-6 animate-fade-in" style={{animationDelay: '0.4s'}}>
          <h2 className="text-xl font-semibold text-slate-700">测试特点</h2>
          <ul className="space-y-3">
            <li className="flex items-center p-3 bg-white/50 rounded-xl hover:bg-white hover:shadow-md transition-all transform hover:scale-105 hover:-translate-y-1">
              ...
              <span className="text-slate-700 font-medium text-sm">科学的16型人格分析体系</span>
            </li>
            <li className="flex items-center p-3 bg-white/50 rounded-xl hover:bg-white hover:shadow-md transition-all transform hover:scale-105 hover:-translate-y-1">
              ...
              <span className="text-slate-700 font-medium text-sm">快速完成，准确分析</span>
            </li>
            <li className="flex items-center p-3 bg-white/50 rounded-xl hover:bg-white hover:shadow-md transition-all transform hover:scale-105 hover:-translate-y-1">
              ...
              <span className="text-slate-700 font-medium text-sm">个性化职业和发展建议</span>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-3">
          <button
            onClick={onStart}
            className="btn-primary w-full py-3 group relative overflow-hidden animate-bounce-in whitespace-nowrap"
